  ...
  describe("execute", () => {
    ...
    describe("Error handling", () => {
      ...
      it("should propagate network errors", async () => {
        mockRepository.searchByName.mockRejectedValue(
    ...
    describe("Edge cases", () => {
      ...
      it("should pass abort signal to repository when provided", async () => {
        mockRepository.searchByName.mockResolvedValue(mockCharacters);
        const abortController = new AbortController();

        await useCase.execute("Spider", { signal: abortController.signal });
