  ...
  describe("execute", () => {
    ...
    describe("Error handling", () => {
      ...
      it("should propagate errors from getComicsByIds", async () => {
        mockRepository.findById.mockResolvedValue(mockCharacter);
        mockRepository.getComicsByIds.mockRejectedValue(
          new Error("Comics API Error"),
        );
    ...
    describe("Results", () => {
      ...
      it("should handle partial results from repository", async () => {
        ...
        mockRepository.findById.mockResolvedValue(mockCharacter);
        const firstTwoComics = mockComics.slice(0, 2);
        mockRepository.getComicsByIds.mockResolvedValue(firstTwoComics);
    ...
    describe("Repository interaction", () => {
      ...
      it("should pass character ID correctly to both methods", async () => {
        ...
        const getComicsByIdsArg =
          mockRepository.getComicsByIds.mock.calls[0]?.[1];
