...
describe('ImageUrl', () => {
  describe('constructor', () => {
    ...
    it('should throw on empty path', () => {
      expect(() => new ImageUrl('', 'jpg')).toThrow('Image path cannot be empty');
    });
    ...
    it('should throw on empty extension', () => {
      expect(() => new ImageUrl('http://example.com/image', '')).toThrow('Image extension cannot be empty');
    });
    ...
    it('should throw on invalid extension', () => {
      expect(() => new ImageUrl('http://example.com/image', 'bmp')).toThrow('Invalid image extension: bmp');
    });

    it('should accept jpg extension', () => {
      expect(() => new ImageUrl('http://example.com/image', 'jpg')).not.toThrow();
    });

    it('should accept jpeg extension', () => {
      expect(() => new ImageUrl('http://example.com/image', 'jpeg')).not.toThrow();
    });

    it('should accept png extension', () => {
      expect(() => new ImageUrl('http://example.com/image', 'png')).not.toThrow();
    });

    it('should accept gif extension', () => {
      expect(() => new ImageUrl('http://example.com/image', 'gif')).not.toThrow();
    });
  ...
  describe('getUrl', () => {
    ...
    it('should return URL with variant', () => {
      const url = new ImageUrl('http://example.com/image', 'jpg');
      expect(url.getUrl('portrait_xlarge')).toBe('http://example.com/image/portrait_xlarge.jpg');
    });

    it('should handle Comic Vine URLs', () => {
      const url = new ImageUrl('https://comicvine.gamespot.com/api/image/screen_large/123', 'jpg');
      expect(url.getUrl()).toBe('https://comicvine.gamespot.com/api/image/screen_large/123.jpg');
    });

    it('should ignore variant for Comic Vine URLs', () => {
      const url = new ImageUrl('https://comicvine.gamespot.com/api/image/screen_large/123', 'jpg');
      expect(url.getUrl('portrait_xlarge')).toBe('https://comicvine.gamespot.com/api/image/screen_large/123.jpg');
    });
  });
