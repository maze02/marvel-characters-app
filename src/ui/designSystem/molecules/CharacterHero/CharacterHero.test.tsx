...
describe('CharacterHero', () => {
  ...
  describe('Rendering', () => {
    it('should render character name', () => {
      ...
      expect(screen.getByRole('heading', { name: 'Spider-Man' })).toBeInTheDocument();
    });
    ...
    it('should render with description', () => {
      ...
      expect(screen.getByText('Spider-Man is a superhero.')).toBeInTheDocument();
    });
  });
  ...
  describe('Description expansion', () => {
    it('should show READ MORE button for long descriptions', () => {
      ...
      renderHero({ description: 'A very long description that will be truncated...' });
